...
const createTaiKhaoThi = async (req, res) => {
    try {
        const { TaiKhaoThiId, QuanNhanId, ThoiDiem, Quy, Nam, HocKy, HinhThucKhaoThi, MaLopHocPhan, MonHoc, KhoiLuongCongViec, SoGioQuyDoi, TrangThai, edituser, edittime, GhiChu } = req.body
        if (!QuanNhanId) {

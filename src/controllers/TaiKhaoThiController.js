...
const createTaiKhaoThi = async (req, res) => {
    try {
        const { TaiKhaoThiId, QuanNhanId, ThoiDiem, Quy, Nam, HocKy, TenHinhThucKhaoThi, MaLopHocPhan, MonHoc, KhoiLuongCongViec, FileCM, SoGioQuyDoi, TrangThai, edituser, edittime, GhiChu } = req.body
        if (!QuanNhanId) {

...
const createTaiHoiDong = async (req, res) => {
    try {
        const { TaiHoiDongId, QuanNhanId, CapHoiDong, LoaiHoiDong, VaiTro, ThoiDiem, Quy, Nam, KhoiLuongCongViec, FileCM, SoGioQuyDoi, TrangThai, edituser, edittime, GhiChu } = req.body
        if (!QuanNhanId) {

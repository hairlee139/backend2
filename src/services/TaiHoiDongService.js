...
const createTaiHoiDong = (newTaiHoiDong) => {
    return new Promise(async (resolve, reject) => {
        const { TaiHoiDongId, QuanNhanId, CapHoiDong, LoaiHoiDong, VaiTro, ThoiDiem, Quy, Nam, KhoiLuongCongViec, SoGioQuyDoi, TrangThai, edituser, edittime, GhiChu } = newTaiHoiDong
        try {
            ...
            const newTaiHoiDong = await TaiHoiDong.create({
                TaiHoiDongId, QuanNhanId, CapHoiDong, LoaiHoiDong, VaiTro, ThoiDiem, Quy, Nam, KhoiLuongCongViec, SoGioQuyDoi, TrangThai, edituser, edittime, GhiChu
            })
            if (newTaiHoiDong) {
                resolve({
                    status: 'OK',
